...
def forward_evidence(client: Client, message: Message, user: User, level: str, rule: str, the_lang: str,
    ...
    try:
        # Get channel id
        channel_id = glovar.logging_channel_id if general else glovar.lang_channel_id

        if not glovar.lang_channel_id:
